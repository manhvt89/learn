...
<ul class="nav nav-tabs" data-tabs="tabs">
    ...
    <li role="presentation">
        <a data-toggle="tab" href="#ctv_tab" title="<?php echo $this->lang->line('config_ctv_configuration'); ?>"><?php echo $this->lang->line('config_ctv'); ?></a>
    </li>
    <li role="presentation">
...
<div class="tab-content">
    ...
    <div class="tab-pane" id="ctv_tab">
        <?php $this->load->view("configs/ctv_config"); ?>
    </div>
