...
class Testex extends Secure_Controller
{
	...
	public function search()
	{
		...
		$sales = $this->Test->search($search, $filters, $limit, $offset, $sort, $order);
	...
	public function select_customer()
	{
        ...
        echo $this->test_lib->get_customer();die();
		$this->_reload();
	}
	...
	public function complete()
	{
        ...
        $obj = array();
        $obj['l_add'] = $this->input->post('l_add');
        $obj['l_ax']=$this->input->post('l_ax');
        $obj['l_cyl'] = $this->input->post('l_cyl');
        $obj['l_pd'] = $this->input->post('l_pd');
        $obj['l_sph'] = $this->input->post('l_sph');
        $obj['l_va'] = $this->input->post('l_va');
        $obj['note'] = $this->input->post('note');
        $obj['r_add'] = $this->input->post('r_add');
        $obj['r_ax'] = $this->input->post('r_ax');
        $obj['r_cyl'] = $this->input->post('r_cyl');
        $obj['r_pd'] = $this->input->post('r_pd');
        $obj['r_sph'] = $this->input->post('r_sph');
        $obj['r_va'] = $this->input->post('r_va');
