...
$config['csrf_exclude_uris'] = array('reports/ajax_inventory_frame_by_cat','reports/ajax_inventory_sun_glasses_by_cat','sales/add','receivings/add','customer_info/index','roles/save_permission_name','roles/switch_permission','roles/switch_action','purchases/do_excel_import');
