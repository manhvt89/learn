...
class Barcode_lib
{
	...
	public function _display_barcode_lens($item, $barcode_config)
	{
		...
		$barcode = $this->generate_barcode($item, $barcode_config);
		$display_table .= "<div style='width:120px; font-size:9px; padding-bottom: 5px;' align='center'><img style='width:120px;height: 20px;' src='data:image/png;base64,$barcode' /></div>";
