...
class Barcode_lib
{
	...
	public function _display_barcode2($item, $barcode_config) // @gong
	{
		...
		$display_table .= "<div align='left' class='barcode-item-".$barcode_config['barcode_second_row']."'>" . $this->manage_display_layout($barcode_config['barcode_second_row'], $item, $barcode_config) . "</div>";
