...
class Barcode_lib
{
	...
	{
		$barcode_config['barcode_width'] = 190;
		...
		$barcode = $this->generate_barcode($item, $barcode_config);
		$display_table .= "<div style='width:120px; font-size:9px;' align='center'><img style='width:120px;' src='data:image/png;base64,$barcode' /></div>";
	...
	private function manage_display_layout($layout_type, $item, $barcode_config)
	{
		...
		return character_limiter($result, 26);
	}
